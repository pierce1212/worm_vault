...
> **<mark style="background: #FF5582A6;">从最后一帧 616 到 CanNm 进入 Bus Sleep</mark>**，理论约 **7 秒**，外加最多一个 10 ms 的 CanNm 调度抖动。
...
**<mark style="background: #FF5582A6;">`CanNm` 进入 Bus Sleep 仅表示网络管理层认为总线可睡。真正的 ECU 下电还要满足项目级条件。</mark>**
