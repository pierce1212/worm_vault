![](assets/0x27(SecurityAccess)/file-20260810115517533.png)27 01 需要扩展会话中。
![](assets/0x27(SecurityAccess)/file-20260810115517539.png)
# 如何解锁安全模式 ？具体的流程又是怎样的？
...
![](assets/0x27(SecurityAccess)/file-20260810115517530.png)
...
![](assets/0x27(SecurityAccess)/file-20260810115517535.png)



关于 sub-function 的具体格式定义如下：

![](assets/0x27(SecurityAccess)/file-20260810115517537.png)
...
# 负响应格式
![](assets/0x27(SecurityAccess)/file-20260810115517527.png)/file-20260702143251563.png)
