...
![](assets/communication%20stack/file-20260605103545141.png)


![Communication Stack Overview](../CAN信号自动测试脚本说明/communication-stack-assets/communication-stack-overview.svg)
...
![Normal Signal TX/RX Chain](../CAN信号自动测试脚本说明/communication-stack-assets/signal-tx-rx-chain.svg)
...
1. 数据传输
   ...
   - `
	   -Com服务中的CAN消息传递路径如下图：
		   - ![](assets/communication%20stack/file-20260605103545140.png)
	   ...
	   - Dcm服务的CAN消息传递路径如下图：
	   - ![](assets/communication%20stack/file-20260605103545138.png)
...
![Diagnostic Chain](../CAN信号自动测试脚本说明/communication-stack-assets/diagnostic-chain.svg)
...
![Network Management Chain](../CAN信号自动测试脚本说明/communication-stack-assets/network-management-chain.svg)
...
![Time Sync Chain](../CAN信号自动测试脚本说明/communication-stack-assets/time-sync-chain.svg)
