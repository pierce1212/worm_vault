# MISRA 2012学习笔记(4)-Rules 8.8-8.9 - 学习笔记

> 来源公众号：汽车电子学习笔记

> 原文标题：MISRA 2012学习笔记(4)-Rules 8.8-8.9

> 原文链接：http://mp.weixin.qq.com/s?__biz=Mzk0NTM4MTI2MA==&mid=2247485406&idx=1&sn=3f19240758ab6f2631d5201564edf894&chksm=c3170d3df460842b70cc657d511d342ba631c6b7b81128fae0c12413bc3f4461f4214b5aa888#rd
...
我的理解是：**MISRA 2012学习笔记(4)-Rules 8.8-8.9** 这类问题的核心，不是把步骤机械跑通，而是把“需求、配置、生成物、运行行为、验证证据”连成闭环。只要闭环断了，项目里就会出现“配置看起来对、代码也生成了、但现象就是不对”的典型问题。
...
这篇文章真正值得学的，不只是 **MISRA 2012学习笔记(4)-Rules 8.8-8.9** 这个具体知识点，而是它展示的工程方法：把一个看似局部的问题，放回 AUTOSAR/MCU/工具链/诊断/测试的完整链路里理解。
