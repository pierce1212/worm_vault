# Python脚本开发-统计Rte中未连接的Port - 学习笔记

> 来源公众号：汽车电子学习笔记

> 原文标题：Python脚本开发-统计Rte中未连接的Port

> 原文链接：http://mp.weixin.qq.com/s?__biz=Mzk0NTM4MTI2MA==&mid=2247488254&idx=1&sn=6920264377e28fad07cc17a8512239a5&chksm=c317181df460910b9dad364739be4800ce09dc160d7a3ea73beceddc872bd7c7c0c290d3a5b5#rd
...
我的理解是：**Python脚本开发-统计Rte中未连接的Port** 这类问题的核心，不是把步骤机械跑通，而是把“需求、配置、生成物、运行行为、验证证据”连成闭环。只要闭环断了，项目里就会出现“配置看起来对、代码也生成了、但现象就是不对”的典型问题。
...
![在这里插入图片描述](https://mmbiz.qpic.cn/sz_mmbiz_png/gEqKyojpCYYrsgxtEDXHobB5rlTZNEvIicUnwotdIB0LPfMCnOsOVoH8dkqzjqib315QNcd7h39CbR6zWDGArlsw/640?wx_fmt=png&from=appmsg)

![在这里插入图片描述](https://mmbiz.qpic.cn/sz_mmbiz_png/gEqKyojpCYYrsgxtEDXHobB5rlTZNEvI8FFFp5zlWKT5LWryvibmxhia9SHPUYjyuA83FNKAgFeU1twToiccAiajwA/640?wx_fmt=png&from=appmsg)

![原文图片 3](https://mmbiz.qpic.cn/sz_mmbiz_gif/gEqKyojpCYbj2Rz4Rm2SpcUYvKWlPBBBKvHMMv6HmicYGRfteF5Vs4lgZSwriattYENZic8gpdIA8iaKG5VSlfhTOw/640?wx_fmt=gif&from=appmsg)
...
这篇文章真正值得学的，不只是 **Python脚本开发-统计Rte中未连接的Port** 这个具体知识点，而是它展示的工程方法：把一个看似局部的问题，放回 AUTOSAR/MCU/工具链/诊断/测试的完整链路里理解。
