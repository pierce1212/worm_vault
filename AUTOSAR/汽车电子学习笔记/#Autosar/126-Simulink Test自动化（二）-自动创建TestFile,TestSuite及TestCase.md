# Simulink Test自动化（二）-自动创建TestFile,TestSuite及TestCase - 学习笔记

> 来源公众号：汽车电子学习笔记

> 原文标题：Simulink Test自动化（二）-自动创建TestFile,TestSuite及TestCase

> 原文链接：http://mp.weixin.qq.com/s?__biz=Mzk0NTM4MTI2MA==&mid=2247484043&idx=1&sn=a5103012a3732132c9a0742d2f1a5777&chksm=c3170868f460817e6fb099fd1f497deff9b78e1c7a9b8dd00a5f91ac0c096403501cdbd413c3#rd
...
我的理解是：**Simulink Test自动化（二）-自动创建TestFile,TestSuite及TestCase** 这类问题的核心，不是把步骤机械跑通，而是把“需求、配置、生成物、运行行为、验证证据”连成闭环。只要闭环断了，项目里就会出现“配置看起来对、代码也生成了、但现象就是不对”的典型问题。
...
![原文图片 1](https://mmbiz.qpic.cn/mmbiz_png/gEqKyojpCYbDmr9hJdLQZTP0OZPEO31yd7nAxCb9Ocg7I4FkdFf4DV9fgQ7ZnxamBDbhmgmcGVeoZuBZtmzLFA/640?wx_fmt=png)
...
这篇文章真正值得学的，不只是 **Simulink Test自动化（二）-自动创建TestFile,TestSuite及TestCase** 这个具体知识点，而是它展示的工程方法：把一个看似局部的问题，放回 AUTOSAR/MCU/工具链/诊断/测试的完整链路里理解。
