# Autosar RTE S/R接口implicit与Explicit的实现与区别 - 学习笔记

> 来源公众号：汽车电子学习笔记

> 原文标题：Autosar RTE S/R接口implicit与Explicit的实现与区别

> 原文链接：http://mp.weixin.qq.com/s?__biz=Mzk0NTM4MTI2MA==&mid=2247484742&idx=1&sn=ade76c0977c2f6bb99859a0898babf53&chksm=c3170fa5f46086b3682ad7638db6cd3efde185521ea8c428bb30cf65426a70b73f43e08c104e#rd
...
我的理解是：**Autosar RTE S/R接口implicit与Explicit的实现与区别** 这类问题的核心，不是把步骤机械跑通，而是把“需求、配置、生成物、运行行为、验证证据”连成闭环。只要闭环断了，项目里就会出现“配置看起来对、代码也生成了、但现象就是不对”的典型问题。
...
![原文图片 1](https://mmbiz.qpic.cn/mmbiz_png/gEqKyojpCYbrOeOBFP0aKdTzo1O66MH4yMkPvT9sf1nZwHdtiaR4M9yW0dov5YydEvpFMRbazfkTo1iblYN6Ygjw/640?wx_fmt=png)

![原文图片 2](https://mmbiz.qpic.cn/mmbiz_png/gEqKyojpCYbrOeOBFP0aKdTzo1O66MH4FjfRMuHL1Eba4RKnR4EveCibOWhotXefwZm8C6y3gBucPKkLzL5OHSg/640?wx_fmt=png)
...
这篇文章真正值得学的，不只是 **Autosar RTE S/R接口implicit与Explicit的实现与区别** 这个具体知识点，而是它展示的工程方法：把一个看似局部的问题，放回 AUTOSAR/MCU/工具链/诊断/测试的完整链路里理解。
