# 初始化函数的用法-节约flash空间的“妙计” - 学习笔记

> 来源公众号：汽车电子学习笔记

> 原文标题：初始化函数的用法-节约flash空间的“妙计”

> 原文链接：http://mp.weixin.qq.com/s?__biz=Mzk0NTM4MTI2MA==&mid=2247488616&idx=1&sn=9e904b75561dbe010c910062db3a5bd8&chksm=c3171e8bf460979ddcb42850de731524f96746715e6de74089d5916c67a48934c3a8b2df8d50#rd
...
我的理解是：**初始化函数的用法-节约flash空间的“妙计”** 这类问题的核心，不是把步骤机械跑通，而是把“需求、配置、生成物、运行行为、验证证据”连成闭环。只要闭环断了，项目里就会出现“配置看起来对、代码也生成了、但现象就是不对”的典型问题。
...
![原文图片 2](https://mmbiz.qpic.cn/sz_mmbiz_gif/gEqKyojpCYbj2Rz4Rm2SpcUYvKWlPBBBKvHMMv6HmicYGRfteF5Vs4lgZSwriattYENZic8gpdIA8iaKG5VSlfhTOw/640?wx_fmt=gif&from=appmsg)
...
这篇文章真正值得学的，不只是 **初始化函数的用法-节约flash空间的“妙计”** 这个具体知识点，而是它展示的工程方法：把一个看似局部的问题，放回 AUTOSAR/MCU/工具链/诊断/测试的完整链路里理解。
