# Simulink脚本自动创建Autosar Parameter Port及Mapping - 学习笔记

> 来源公众号：汽车电子学习笔记

> 原文标题：Simulink脚本自动创建Autosar Parameter Port及Mapping

> 原文链接：http://mp.weixin.qq.com/s?__biz=Mzk0NTM4MTI2MA==&mid=2247483966&idx=1&sn=c6e268bcf34a9e9e01c7728552dd3e1b&chksm=c31708ddf46081cbd0dec6036c1f294355d0753c7f843f92a66f03fbf7967660124538e2dea2#rd
...
我的理解是：**Simulink脚本自动创建Autosar Parameter Port及Mapping** 这类问题的核心，不是把步骤机械跑通，而是把“需求、配置、生成物、运行行为、验证证据”连成闭环。只要闭环断了，项目里就会出现“配置看起来对、代码也生成了、但现象就是不对”的典型问题。
...
![原文图片 1](https://mmbiz.qpic.cn/mmbiz_png/gEqKyojpCYaLus5LUvlCx6rjE4nQaWhQKfloUHw7Xx2gqSvVVfNWzJicEKC9gkPZxS1MdRTmc36AmyLE8Ed0Vsw/640?wx_fmt=png)

![原文图片 2](https://mmbiz.qpic.cn/mmbiz_png/gEqKyojpCYaLus5LUvlCx6rjE4nQaWhQJp8lHSecYsLKicwYvE4MYuqC1Fkkxc6XqM2nd7k7EF4nCTPllicpLHGg/640?wx_fmt=png)

![原文图片 3](https://mmbiz.qpic.cn/mmbiz_png/gEqKyojpCYaLus5LUvlCx6rjE4nQaWhQCibrQCreO1DUmiaCcqx5zw23encbbKZPGsZyFLRAXByoaEGd0HL9OETw/640?wx_fmt=png)

![原文图片 4](https://mmbiz.qpic.cn/mmbiz_png/gEqKyojpCYaLus5LUvlCx6rjE4nQaWhQNhg1C4Id7TPrFNZJmNDJia4uGWto4DQbmZzD6pbZN8aOgduplNz7uUA/640?wx_fmt=png)
...
这篇文章真正值得学的，不只是 **Simulink脚本自动创建Autosar Parameter Port及Mapping** 这个具体知识点，而是它展示的工程方法：把一个看似局部的问题，放回 AUTOSAR/MCU/工具链/诊断/测试的完整链路里理解。
