...
![](assets/AUTOSAR%20--%20EcuM标准流程/file-20260703142703857.png)

当 Ecu 上电时，唤醒源的初始状态是 NONE，当唤醒源状态切换到 NONE 时，需要通知到 BswM 模块，上图也可以看出，唤醒源的每次状态切换都需要通知到 BswM 模块，通知接口：BswM_EcuM_CurrentWakeup。
